       ...
       <section className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-[#12141e] rounded-lg p-6 border border-[#1e2230] transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-[#1199fa]/20 hover:-translate-y-2 hover:bg-[#1a1d2a]">
